...
function fadeAnimation() {
  if ($('.tp_fade_bottom').length > 0) {
    gsap.set('.tp_fade_bottom', { y: 300, opacity: 0 });
...
function revelAnimationOne() {
  const anim_reveal: NodeListOf<HTMLElement> = document.querySelectorAll('.tp_reveal_anim');
...
function revelAnimationTwo() {
  const anim_reveal2: NodeListOf<HTMLElement> = document.querySelectorAll('.tp_reveal_anim-2');
