      ...
      <div className="container container-1800">
        <div className="row gx-0 grid-2" ref={isotopContainer}>
          {portfolio_masonry_data.map((item) => (
            <div key={item.id} className={`col-xl-${item.id === 6 ? 12 : 6} grid-item`}>
              <div className="pm-project-masonary-item p-relative">
                <div className="fix">
                  <Image src={item.img} alt="masonry-img" style={{ height: 'auto' }} />
                </div>
                <div className="pm-project-masonary-content">
                  <span className="pm-project-masonary-subtitle">{item.subtitle}</span>
