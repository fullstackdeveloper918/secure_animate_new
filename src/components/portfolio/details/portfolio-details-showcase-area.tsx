    ...
    <>
      ...
      <div className="tp-showcase-details-area">
        <div
          ...
          style={{ backgroundImage: 'url(/assets/img/inner-project/showcase/showcase-1.jpg)' }}
        >
            ...
            <div className="col-xl-8">
              <div className="showcase-details-overview-right">
                <p className="tp_title_anim">
                  Eagle Films is an active player on the entertainment scene as a major Hollywood
                  movies distributor and co-producer. They reach out to me to not only redesign
                  their website but also to change the look and feel of their brand.
                </p>
          ...
          <div className="row">
            ...
            <div className="col-xl-8">
              <div className="showcase-details-overview-right tp_title_anim">
                <p>
                  Blue Marine Foundation challenged us to create a digital experience that
                  successfully educates people on the importance of our oceans and the solutions we
                  can implement to mitigate climate change. The health of the ocean affects us all
                  and for that reason, the site needed to connect with as many people as possible,
                  from students to policymakers. The journey begins with an introduction to ocean
                  preservation, in the form of a meditative breathing exercise. This aims to reduce
                  tension and in-turn improve concentration and memory.
                </p>
              </div>
            </div>
          </div>
