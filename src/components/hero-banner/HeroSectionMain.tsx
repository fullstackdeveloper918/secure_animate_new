...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto relative z-10 pt-[50px]">
        <motion.div
          className="max-w-3xl"
          style={{
            y: textY,
        ...
        >
          ...
          >
            <span className="text-white block">Secure in This Galaxy</span>
          ...
          <motion.p
            className="text-lg md:text-xl text-purple-100 mb-12 max-w-2xl"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
...
>
  Start Your Mission <Rocket className="ml-2 h-5 w-5" />
      ...
      <div className="absolute bottom-0 left-0 right-0 h-40 bg-gradient-to-t from-[#040720] to-transparent z-10"></div>
    </section>
  );
}
