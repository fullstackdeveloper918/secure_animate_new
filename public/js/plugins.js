...
!(function (e) {
  'function' == typeof define && define.amd
    ...
    : 'object' == typeof module && module.exports
      ? (module.exports = function (t, i) {
          return (
            void 0 === i &&
              (i = 'undefined' != typeof window ? require('jquery') : require('jquery')(t)),
            e(i),
            i
          );
        })
  ...
  (r.prototype.getSuffix = function (t, i) {
        ...
        for (i = 0; i < this.buildingRow.entriesBuff.length; i++)
          (e = this.buildingRow.entriesBuff[i]),
            this.settings.cssAnimation
              ...
              : (e.stop().fadeTo(0, 0.1), e.find('> img, > a > img').fadeTo(0, 0));
        return -1;
      }
      for (
        t &&
          ...
          0 < this.rows &&
            (o =
              ((g = (this.offY - this.border - this.settings.margins * this.rows) / this.rows) *
        ...
        (s = (e = this.buildingRow.entriesBuff[i]).data('jg.width') / e.data('jg.height')),
          o
            ? ((n = i === this.buildingRow.entriesBuff.length - 1 ? h : l * s), (r = l))
            : ((n = g * s), (r = g)),
          (h -= Math.round(n)),
    ...
    (r.prototype.flushRow = function (t) {
      var i,
        ...
        n = this.settings,
        r = this.border;
      if (((e = this.prepareBuildingRow(t)), t && 'hide' === n.lastRow && -1 === e))
  ...
  (r.prototype.rememberGalleryHeight = function () {
      ...
      this.checkWidthIntervalId = setInterval(
        g.proxy(function () {
          if (this.$gallery.is(':visible')) {
            ...
            e() === this.scrollBarOn
              ? Math.abs(t - this.galleryWidth) > this.settings.refreshSensitivity &&
                ((this.galleryWidth = t),
                this.rewind(),
    ...
    (r.prototype.updateEntries = function (t) {
      ...
      return (
        t && null != this.lastFetchedEntry
          ? (i = g(this.lastFetchedEntry).nextAll(this.settings.selector).toArray())
          : ((this.entries = []), (i = this.$gallery.children(this.settings.selector).toArray())),
        0 < i.length &&
    ...
    (r.prototype.stopImgAnalyzerStarter = function () {
      (this.yield.flushed = 0),
        null !== this.imgAnalyzerTimeout &&
          (clearTimeout(this.imgAnalyzerTimeout), (this.imgAnalyzerTimeout = null));
    }),
    ...
    (r.prototype.checkOrConvertNumber = function (t, i) {
      if (('string' === g.type(t[i]) && (t[i] = parseFloat(t[i])), 'number' !== g.type(t[i])))
    ...
    (r.prototype.retrieveMaxRowHeight = function () {
      ...
      if ('string' === g.type(this.settings.maxRowHeight))
        t = this.settings.maxRowHeight.match(/^[0-9]+%$/)
          ? (i * parseFloat(this.settings.maxRowHeight.match(/^([0-9]+)%$/)[1])) / 100
...
!(function (a, b, c) {
  ...
  var l = function (a) {
      var c;
      b.isPlainObject(a) ? (c = d.prototype) : ((c = k[a]), (a = arguments[1] || {})),
        b.extend(c, a);
    },
    m = {
      popup: function (c) {
...
class GridToFullscreenEffect {
  constructor(e, n, t = {}) {
    (this.container = e),
      (this.itemsWrapper = n),
      (this.itemsWrapperChildren = n.querySelectorAll('.trigger-item')),
      (this.initialised = !1),
      (this.camera = null),
      (this.scene = null),
      (this.renderer = null),
      ...
      (t.activation.type = t.activation.type || 'none'),
      (t.seed = t.seed || 0),
      (t.easings = t.easings || {}),
  ...
  createTextures(e) {
    ...
    for (let t = 0; t < e.length; t++) {
      ...
      const s = {
        ...
        small: { element: r.small.element, texture: o },
      };
      n.push(s);
    }
  ...
  setCurrentTextures() {
    ...
    (this.uniforms.uImage.value = e.small.texture),
      ...
      (this.uniforms.uImageLargeRes.value.x = e.large.texture.image.naturalWidth),
      (this.uniforms.uImageLargeRes.value.y = e.large.texture.image.naturalHeight),
  ...
  init() {
    ...
    const t =
      (r = this.options.transformation.type) && '[object Function]' === {}.toString.call(r)
  ...
  toGrid() {
    this.isFullscreen &&
      !this.isAnimating &&
      ((this.isAnimating = !0),
      this.options.onToGridStart && this.options.onToGridStart({ index: this.currentImageIndex }),
        ...
        onComplete: () => {
          (this.isAnimating = !1),
            ...
            this.options.onToGridFinish &&
              this.options.onToGridFinish({ index: -1, lastIndex: this.currentImageIndex }),
            (this.currentImageIndex = -1);
        },
      })));
  }
  recalculateUniforms(e) {
    ...
    const n = this.itemsWrapperChildren[this.currentImageIndex].children[0].getBoundingClientRect(),
      t = { x: (e.clientX - n.left) / n.width, y: 1 - (e.clientY - n.top) / n.height },
      r =
    ...
    (u.position.x = c),
      (u.position.y = m),
      (this.uniforms.uPlaneCenter.value.x = c / o),
      (this.uniforms.uPlaneCenter.value.y = m / s),
      (this.uniforms.uMeshScale.value.x = o),
      (this.uniforms.uMeshScale.value.y = s),
      (this.uniforms.uScaleToViewSize.value.x = i.width / o - 1),
      (this.uniforms.uScaleToViewSize.value.y = i.height / s - 1);
  }
  toFullscreen(e, n) {
    if (!this.isFullscreen && !this.isAnimating) {
      if (
        ...
        (this.uniforms.uImage.value = n.small.texture),
          (this.uniforms.uImageRes.value.x = n.small.texture.image.naturalWidth),
          (this.uniforms.uImageRes.value.y = n.small.texture.image.naturalHeight),
          (this.uniforms.uImageLarge.value = n.large.texture),
          (this.uniforms.uImageLargeRes.value.x = n.large.texture.image.naturalWidth),
          (this.uniforms.uImageLargeRes.value.y = n.large.texture.image.naturalHeight);
      }
  ...
  onResize(e) {
    (this.camera.aspect = window.innerWidth / window.innerHeight),
      ...
      this.renderer.setSize(window.innerWidth, window.innerHeight),
      this.currentImageIndex > -1 && (this.recalculateUniforms(e), this.render());
  }
}
var activations = {
...
const transformations = {
  ...
  simplex: (e) => {
    ...
    let n = ensureFloat(e.amplitudeX || 0.5),
      ...
      o = ensureFloat(e.progressLimit || 0.5);
  ...
  fluid: (e) => {
    const n = ensureFloat(e.frequency || 1),
      t = ensureFloat(e.amplitude || 0.3);
    let r = ensureFloat((e.x || 0.5) - 0.5),
      i = ensureFloat((e.y || 0.5) - 0.5);
    e.onMouse && ((r = 'uMouse.x - 0.5'), (i = 'uMouse.y - 0.5'));
    const o = ensureFloat(e.progressLimit || 0.5);
